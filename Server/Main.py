...
from Data import make_userdata_by_selected_name, make_userdata
#data initialize
array=[[0	,480,	4 ],
[0	,481,	4 ],
[0	,482,	0 ],
...
def get_recommendation_list(uid):
    ...
    grp1 = arr[0]
    grp2 = arr[1]
    list1 = group.user_group(uid, grp1, False)
    list2 = group.user_group(uid, grp2, False)
    result = []
    for i in range(0, 4):
...
#print(get_recommendation_list(20))
'''
array = []
make_userdata_by_selected_name(array, 'cndgus1902')
print(array)
'''
